            ...
            <?php
                ...
                <div class="col-md-12">
                    <div class="card-box">
                      ...
                      <small><a href="<?=base_url();?>assets/naivebayes/dataaset-naivebayes-1.xlsx" target="_blank">Download contoh Format .xlsx</a></small>
                      <br>
                        ...
                        <div class="card-box">
                            <div class="row">
                                <div class="col-md-12 table-responsive">
                                    ...
                                    <div class="card card-body <?php if((round($TP/($TP+$FP),3)*100)<60){echo 'bg-danger';}else if((round($TP/($TP+$FP),3)*100)<80){echo 'bg-warning';}else{echo 'bg-primary';} ?> text-white">
